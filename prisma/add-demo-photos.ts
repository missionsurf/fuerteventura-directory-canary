...
const dbUrl = process.env.DATABASE_URL ?? "file:/Users/roger/Projects/fuerteventura-directory/prisma/dev.db"
...
async function main() {
  // El Faro Restaurant — 5 photos + full menu
  ...
  console.log("✓ El Faro Restaurant updated")

  // Flag Beach Kite Center — 4 photos
  await prisma.business.update({
  ...
  console.log("✓ Flag Beach Kite Center updated")

  // Villa Atlantica — 3 photos
  await prisma.business.update({
  ...
  console.log("✓ Villa Atlantica updated")

  // Corralejo Surf School — 3 photos
  await prisma.business.update({
  ...
  console.log("✓ Corralejo Surf School updated")

  console.log("\nAll demo photos added!")
}
